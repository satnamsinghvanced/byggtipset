...
export async function generateMetadata() {
  ...
  if (!termsData) {
    return generatePageMetadata({
      title: "Terms of Service | Byggtipset.no",
      description: "Byggtipset.no terms of service page",
      path: "/tjenestevilkar",
    });
  }
  const {
  ...
  return generatePageMetadata({
    ...
    ogTitle:
      ogTitle || metaTitle || title || "Terms of Service | Byggtipset.no",
    ogDescription:
      ogDescription ||
      metaDescription ||
      "Learn the terms of service for Byggtipset.no",
