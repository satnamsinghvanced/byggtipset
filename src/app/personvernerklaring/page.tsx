...
export async function generateMetadata() {
  ...
  if (!privacyPolicyData) {
    return generatePageMetadata({
      title: "Privacy Policy | Byggtipset.no",
      description: "Byggtipset.no privacy policy page",
  ...
  return generatePageMetadata({
    ...
    ogTitle:
      ogTitle || metaTitle || title || "Privacy Policy | Byggtipset.no",
    ogDescription:
      ogDescription ||
      metaDescription ||
      "Learn how Byggtipset.no protects your privacy and handles your personal information.",
