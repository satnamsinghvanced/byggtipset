...
export async function generateMetadata() {
  ...
  if (!partnerData) {
    return generatePageMetadata({
      title: "Partner | Byggtipset.no",
      description: "Join the Byggtipset network and collaborate with us",
      path: "/partner",
    });
  }
  ...
  return generatePageMetadata({
    ...
    description:
      metaDescription ||
      subHeading ||
      "Learn more about becoming a Byggtipset partner",
    path: slug || "/partner",
    ...
    ogDescription:
      ...
      metaDescription ||
      subHeading ||
      "Join the Byggtipset network and collaborate with us",
