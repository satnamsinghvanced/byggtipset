...
export async function generateMetadata({
  ...
  if (!articlesData?.data) {
    return generatePageMetadata({
      title: `${category} Artikler | Byggtipset.no`,
      description: `Read expert articles about ${category} on Byggtipset.no.`,
  ...
  return generatePageMetadata({
    title: metaTitle || `${category} Artikler | Byggtipset.no`,
    description:
      metaDescription ||
      `Read expert Artikler om ${category} on Byggtipset.no.`,
    path: pathname,
    keywords: metaKeywords
      ? metaKeywords
        ...
        ?.map((k: string) => k.trim())
        .filter(Boolean)
      : ["byggtipset", category, "real estate", "artikler"],
    type: ogType || "website",
    image: ogImage || null,
    ogTitle: ogTitle || metaTitle || `${category} Artikler | Byggtipset.no`,
    ogDescription:
      ogDescription ||
      metaDescription ||
      `Explore helpful ${category} artikler from Byggtipset.no.`,
